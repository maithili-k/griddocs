...
When users start working on the grid, or interact with dCache for data transfers, a link:http://doc.grid.surfsara.nl/en/latest/Pages/Advanced/grid_authentication.html[proxy] is created based on the user's 
